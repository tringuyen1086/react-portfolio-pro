...
function Resume() {
    ...
    return (
        <div className="resume" id="resume">
            ...
            <p>Please check out <a href="https://drive.google.com/file/d/1zH2eC6FopspQwDVc7qZWNeL3EJ0f69z3/view?usp=sharing" target="_blank" rel="noreferrer">downloadable resume here</a></p>
